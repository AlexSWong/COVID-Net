...
### Updates
- **April 10, 2021**: Major release of **TB-Net**, a tailored neural network for detection of tuberculosis from chest x-ray images [(Model)](https://github.com/darwinai/TuberculosisNet) [(Paper)](https://arxiv.org/abs/2104.03165)
...
### COVID-Net Resources
- <img src="covidnetlogo.png" alt="COVID-Net" width="3%" height="3%"> **COVID-Net CXR: tailored deep convolutional neural networks for detection of COVID-19 cases from chest X-ray images** 
